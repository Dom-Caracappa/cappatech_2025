...
app.use(cors({
    origin: [
        "http://localhost:4321", // main-site expected
        "http://localhost:4322", // if main-site sneaks to this
        "http://localhost:5042", // where Vite is likely running
        "https://admin.cappatech.net" // production // Production frontend
    ],
