...
export default function Hero3D() {
    ...
    return (
        <section className="relative mx-auto w-full max-w-4xl mb-16">
            {/* TEXT OVERLAY */}
            <div className="absolute inset-0 mt-32 z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4">
